...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    $("body").mouseover(function () {
      $("#footer")
        .fadeIn("")
        .css({ bottom: -20, position: "fixed" })
        .animate({ bottom: -20 }, 200, function () {});
    });
  }),
  $(document).ready(function () {
...
function loadGoogleAnalytics() {
  var script = document.createElement('script');
   script.src = "https://www.googletagmanager.com/gtag/js?id=UA-xxx-x";
  script.async = true;
